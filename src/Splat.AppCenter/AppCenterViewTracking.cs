...
/// <summary>Provides view tracking functionality for navigation events, enabling integration with App Center Analytics.</summary>
...
public sealed class AppCenterViewTracking : IViewTracking
{
    ...
    /// <summary>Creates a dictionary containing a single entry with the specified name.</summary>
