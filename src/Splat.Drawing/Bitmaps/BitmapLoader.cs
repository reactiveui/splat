...
public static class BitmapLoader
{
    ...
    /// <summary>Gets the current bitmap loader state, if available. Used by test scopes.</summary>
    ...
    /// <summary>Restores the current bitmap loader state to the specified value. Used by test scopes.</summary>
    ...
    /// <summary>Resets the internal bitmap loader state to use the current application service instance. Used by test scopes.</summary>
