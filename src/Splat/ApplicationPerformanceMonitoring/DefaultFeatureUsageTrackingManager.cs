...
{
    /// <summary>Initializes a new instance of the <see cref="DefaultFeatureUsageTrackingManager"/> class.</summary>
    public DefaultFeatureUsageTrackingManager()
        : base(static featureName => new DefaultFeatureUsageTrackingSession(featureName))
    {
    }
}
