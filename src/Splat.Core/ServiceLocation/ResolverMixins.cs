...
public static class ResolverMixins
{
    ...
    extension(IMutableDependencyResolver resolver)
    {
        ...
        public IMutableDependencyResolver RegisterAnd<TService>()
            where TService : new()
        {
        ...
        public IMutableDependencyResolver RegisterAnd<TService>(string contract)
            where TService : new()
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <returns>The same dependency resolver instance, to allow for method chaining.</returns>
        public IMutableDependencyResolver RegisterAnd<TService>(Func<TService> factory)
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <returns>The same dependency resolver instance, to allow for method chaining.</returns>
        public IMutableDependencyResolver RegisterAnd<TService>(Func<TService> factory, string contract)
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
            ArgumentExceptionHelper.ThrowIfNull(factory);

            resolver.Register(() => factory()!, contract);
            return resolver;
        }

        /// <summary>Registers a service implementation with the dependency resolver and returns the resolver for chaining.</summary>
        ...
        public IMutableDependencyResolver RegisterAnd<TService, TImplementation>()
        ...
        /// <returns>The same dependency resolver instance, to allow for method chaining.</returns>
        public IMutableDependencyResolver RegisterAnd<TService, TImplementation>(string contract)
            where TImplementation : TService, new()
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <returns>The same <see cref="IMutableDependencyResolver"/> instance, to allow for method chaining.</returns>
        public IMutableDependencyResolver RegisterAnd<TService, TImplementation>(Func<TImplementation> factory)
        ...
        public IMutableDependencyResolver RegisterAnd<TService, TImplementation>(Func<TImplementation> factory, string contract)
            where TImplementation : TService
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
            ArgumentExceptionHelper.ThrowIfNull(factory);
        ...
        public IMutableDependencyResolver RegisterConstantAnd(object value, Type serviceType)
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        public IMutableDependencyResolver RegisterConstantAnd(object value, Type serviceType, string contract)
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <typeparam name="TService">The type of service to register. Must have a public parameterless constructor.</typeparam>
        /// <returns>The same dependency resolver instance, to support method chaining.</returns>
        public IMutableDependencyResolver RegisterConstantAnd<TService>()
            where TService : new()
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <summary>Registers a singleton instance of the specified service type and returns the resolver to enable method chaining.</summary>
        ...
        public IMutableDependencyResolver RegisterConstantAnd<TService>(string contract)
            where TService : new()
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <summary>Registers a constant instance of the specified service type and returns the resolver for chaining.</summary>
        ...
        /// service type.</param>
        /// <returns>The same dependency resolver instance, to support method chaining.</returns>
        public IMutableDependencyResolver RegisterConstantAnd<TService>(TService value)
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// null or empty.</param>
        /// <returns>The same dependency resolver instance, enabling method chaining.</returns>
        public IMutableDependencyResolver RegisterConstantAnd<TService>(TService value, string contract)
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <summary>Registers a singleton service with lazy initialization and returns the dependency resolver for chaining.</summary>
        ...
        /// <returns>The same dependency resolver instance, enabling method chaining.</returns>
        public IMutableDependencyResolver RegisterLazySingletonAnd(Func<object> valueFactory, Type serviceType)
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// null or empty for the default contract.</param>
        /// <returns>The same dependency resolver instance, enabling method chaining.</returns>
        public IMutableDependencyResolver RegisterLazySingletonAnd(Func<object> valueFactory, Type serviceType, string contract)
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <typeparam name="TService">The type of service to register. Must have a public parameterless constructor.</typeparam>
        /// <returns>The same dependency resolver instance, to support method chaining.</returns>
        public IMutableDependencyResolver RegisterLazySingletonAnd<TService>()
            where TService : new()
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <returns>The same dependency resolver instance, enabling method chaining.</returns>
        public IMutableDependencyResolver RegisterLazySingletonAnd<TService>(string contract)
            where TService : new()
        {
            ArgumentExceptionHelper.ThrowIfNull(resolver);
        ...
        /// <summary>Registers a singleton service of type TService using a lazy value factory and returns the resolver for chaining.</summary>
