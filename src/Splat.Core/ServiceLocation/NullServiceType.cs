...
{
    /// <summary>Gets the cached <see cref="Type"/> instance representing the <see cref="NullServiceType"/> type.</summary>
    ...
    /// <summary>Gets the function used to create an instance of the associated object.</summary>
